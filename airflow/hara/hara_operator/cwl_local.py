...
class CwlLocalOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        self.log.warning('tp--------------')
        self.log.warning('tp--------------')
        # self.log.info('bash input: %s', self.bash_command)
        self.log.warning('tp--------------')
        self.log.warning('tp--------------')
        self.log.warning('tp--------------')
        ...
        # cwl_commands = ['cwltool'CwlCommandLineToolOperator, self.cwl_path, self.job_path]
        cwl_command = 'cwltool '+ self.cwl_path + ' '+self.job_path

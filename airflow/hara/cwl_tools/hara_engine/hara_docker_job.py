...
from cwltool.docker_id import docker_vm_id
from cwltool.errors import WorkflowException
from cwltool.loghandler import _logger
from cwltool.pathmapper import MapperEnt, PathMapper
from cwltool.utils import CWLObjectType, create_tmp_dir, ensure_writable
from airflow.hara.cwl_tools.hara_engine.hara_job import ContainerCommandLineJob
...
class HaraDockerCommandLineJob(ContainerCommandLineJob):
    ...
    def get_image(
        ...
        if (force_pull or not found) and pull_image:
            ...
            if "dockerPull" in docker_requirement:
                ...
                # self.outdir: '/home/typingliu/temp/abc/tmp_outdir/dataset_extraction_1'
                if not os.path.exists(self.outdir):
                    os.makedirs(self.outdir)
                subprocess.check_call(cmd, stdout=open(os.path.join(self.outdir, 'error.log'), 'w'))  # nosec
                # hara change ends;
                found = True
...
class PodmanCommandLineJob(HaraDockerCommandLineJob):

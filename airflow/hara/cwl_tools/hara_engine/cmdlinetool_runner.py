...
from cwltool.mpi import MPIRequirementName
...
from cwltool.update import ORDERED_VERSIONS, ORIGINAL_CWLVERSION
...
class HaraLocalCommandLineTool(Process):
    ...
    def job(
        ...
        output_callbacks: Optional[OutputCallbackType],
        runtimeContext: RuntimeContext,
    ) -> Type[JobBase]: # TODO harada do not yield.

...
from cwltool.workflow_job import WorkflowJob, WorkflowJobStep
import logging
...
class HaraCwlEngine:
    ...
    def load_configuration(self, cwl: str) -> workflow.Workflow: # workflow.Workflow is derived from Process
